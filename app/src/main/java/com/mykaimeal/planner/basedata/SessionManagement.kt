...
class SessionManagement(var context: Context) {
    ...
    fun setCreateRecipe(data:String){
        editor!!.putString(AppConstant.createRecipe, data)
        editor!!.commit()
    }
    ...
    fun getCreateRecipe(): String? {
        return pref!!.getString(AppConstant.createRecipe, "")
    }
    ...
    fun setCountHealth(count: Int?) {
        editor!!.putInt(AppConstant.totalCountSession, count!!)
        editor!!.commit()
    }
    ...
    fun getCountHealth(): Int? {
        return pref?.getInt(AppConstant.totalCountSession, 0)
    }
