...
class AdapterOrderHistoryItem(
    private var datalist: MutableList<OrderHistoryModelData>,
    private var requireActivity: FragmentActivity,
    private var onItemClickedListener: OnItemClickedListener
) : RecyclerView.Adapter<AdapterOrderHistoryItem.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding: AdapterOrderHistoryItemBinding =
            AdapterOrderHistoryItemBinding.inflate(inflater, parent, false)
        ...
        data.let {
            ...
            if (date != null && totalWithTip != null && itemsSize > 0) {
                holder.binding.tvDate.text =
                    "${BaseApplication.formatDateMonth(date)} • $$formattedTotalWithTip • $itemsSize items"
            }
    ...
    class ViewHolder(var binding: AdapterOrderHistoryItemBinding) :
