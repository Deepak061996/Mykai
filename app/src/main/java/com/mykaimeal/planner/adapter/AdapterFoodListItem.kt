...
class AdapterFoodListItem(var itemList: MutableList<com.mykaimeal.planner.fragment.mainfragment.cookedtab.apiresponse.Breakfast>, var type:String?, private var requireActivity: FragmentActivity, private var onItemSelectListener: OnItemClickListener) : RecyclerView.Adapter<AdapterFoodListItem.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemSelectListener.itemClick(position, "5", type)
        }
    }

    @SuppressLint("NotifyDataSetChanged")
    fun updateList(itemListdata: MutableList<com.mykaimeal.planner.fragment.mainfragment.cookedtab.apiresponse.Breakfast>, typechange: String){
