...
class CustomDatePickerIngredientView @JvmOverloads constructor(
    context: Context,
    ...
    private fun setupDefaults() {
        ...
        val defaultDate = Calendar.getInstance() // Current date
    ...
    private fun isValidDateSelection(year: Int, month: Int, day: Int): Boolean {
        ...
        // Only check that date is not in future
        ...
        return !selectedCal.after(currentCal)
    }
