...
interface MainRepository {
 ...
 suspend fun scanImageRequestApi(successCallback: (response: NetworkResult<String>) -> Unit,jsonObject: JsonObject)
 ...
 suspend fun createRecipeRequestApi(
     successCallback: (response: NetworkResult<String>) -> Unit,
     jsonObject: JsonObject,
     screenName: String
 )

 suspend fun convertUnitRequestApi(
     successCallback: (response: NetworkResult<String>) -> Unit,
     jsonObject: JsonObject
 )
 ...
 suspend fun planPaginationRequest(successCallback: (response: NetworkResult<String>) -> Unit, pageType: String)

 suspend fun planDateRequestApi(successCallback: (response: NetworkResult<String>) -> Unit, date: String,planType:String)
 suspend fun cookPlanDateRequestApi(successCallback: (response: NetworkResult<String>) -> Unit, date: String,planType:String)
 ...
 suspend fun moveRecipeRequestApi(successCallback: (response: NetworkResult<String>) -> Unit, id: String, cookBook: String)
 ...
 suspend fun addBankRequestApi(
    ...
    suspend fun addShoppingCartUrlApi(successCallback: (response: NetworkResult<String>) -> Unit,foodIds: MutableList<String>?,
                                schId:MutableList<String>?, foodName:MutableList<String>?,status: MutableList<String>?,uri:String,type:String)

    suspend fun addShoppingCheckApi(successCallback: (response: NetworkResult<String>) -> Unit,ids: MutableList<String>?)

    suspend fun addPurchasedElemenentsUrlApi(successCallback: (response: NetworkResult<String>) -> Unit,ids: MutableList<String>?)
    ...
    suspend fun removeMealCookApi(successCallback: (response: NetworkResult<String>) -> Unit, cookedId:String?)

    suspend fun removeBasketUrlApi(successCallback: (response: NetworkResult<String>) -> Unit, recipeId:String?)

    suspend fun getInstaCart(successCallback: (response: NetworkResult<String>) -> Unit,jsonObject: JsonObject?)

    suspend fun basketYourRecipeIncDescUrl(successCallback: (response: NetworkResult<String>) -> Unit, uri:String?,quantity:String?,type:String?)
    ...
    suspend fun getRecipeByUrl(successCallback: (response: NetworkResult<String>) -> Unit, q:String?)
    ...
    suspend fun getScheduleTimeApi(successCallback: (response: NetworkResult<String>) -> Unit,date:String?,days:String?,type:String?)

    suspend fun setScheduleTimeApi(successCallback: (response: NetworkResult<String>) -> Unit,date: String?,
                                   startTime: String?,
                                   endTime: String?,
                                   discount: String)
    ...
    suspend fun getOrderProductUrl(
        successCallback: (response: NetworkResult<String>) -> Unit,
    ...
    suspend fun orderWeekUrl(successCallback: (response: NetworkResult<String>) -> Unit, startDate:String?,endDate:String?,year:String?)
