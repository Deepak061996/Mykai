...
interface ApiInterface {
    ...
    suspend fun userProfileUpdateApi(
        ...
        @Field("target_weight") targetWeight: String,
        @Field("target_weight_type") targetWeightType: String,
        @Field("macros") macros: String,
        @Field("target") target: String,
        @Field("macro_carbs") carbsPer: String,
        @Field("macro_protein") proteinPer: String,
        @Field("macro_fat") fatPer: String,
        @Field("time") time: String,
        @Field("value_per_week") valuePerWeek: String,
        @Field("typeStatus") typeStatus: String,
        @Field("old_macro") oldMacro: String
    ): Response<JsonObject>
    ...
    @POST(ApiEndPoint.scanImageUrl)
    suspend fun scanImageRequestApi(@Body jsonObject: JsonObject): Response<JsonObject>


    @FormUrlEncoded
    @POST(ApiEndPoint.recipeDetailsUrl)
    suspend fun recipeDetailsRequestApi(
        @Field("uri") url: String,
        @Field("id") recipeID: String,
        @Field("type") statusType: String,
        @Field("servings") serving: String
    ): Response<JsonObject>
    ...
    @POST(ApiEndPoint.convertUnits)
    suspend fun convertUnitRequestApi(@Body jsonObject: JsonObject): Response<JsonObject>

    @POST(ApiEndPoint.editMealUrl)
    suspend fun editRecipeRequestApi(@Body jsonObject: JsonObject): Response<JsonObject>

    @POST(ApiEndPoint.getCookBookUrl)
    suspend fun getCookBookRequestApi(): Response<JsonObject>

    @GET(ApiEndPoint.imperialUnitList)
    suspend fun getUnitRequest(): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.allrecipepaginationUrl)
    suspend fun planPaginationRequest(@Field("meal_type") mealType: String): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.getCookMealsUrl)
    suspend fun cookPlanDateRequestApi(
        @Field("date") date: String,
        @Field("plan_type") planType: String
    ): Response<JsonObject>
    ...
    suspend fun userPreferencesDislikeApi(
        @Field("dislike_search") dislikeSearch: String?,
        @Field("dislike_num") dislikeNum: String?
    ): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.estimatedApi)
    suspend fun userEstimatedApi(
        @Field("weight") weight: Double?,
        @Field("weight_type") weightType: String?,
        @Field("target_weight") targetWeight: Double?,
        @Field("target_weight_type") targetWeightType: String?,
    ...
    suspend fun recipeFilterSearchApi(
        ...
        @Field("time") time: String?,
        @Field("cuisineType[]") cuisine: MutableList<String>?,
        @Field("calories") nutrition: String?
    ): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.addToCartCheckUrl)
    suspend fun addShoppingCheckApi(
        @Field("id[]") ids: MutableList<String>?
    ): Response<JsonObject>

    @FormUrlEncoded
    @POST(ApiEndPoint.addPurchasedElemenentsUrl)
    suspend fun addPurchasedElemenentsUrlApi(
        @Field("id[]") ids: MutableList<String>?
    ): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.userPurchasedURL)
    suspend fun addGraphDataApi(
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.recipeFromUrl)
    suspend fun recipeSearchFromURLApi(
        @Field("url") q: String?
    ): Response<JsonObject>

    @GET(ApiEndPoint.ingredientAndCookware + "/{search}" + "/{type}")
    suspend fun recipeSearchIngredientApi(@Path("search") search: String?,@Path("type") type: String?): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.removeCookMeal)
    suspend fun removeMealCookApi(
        @Field("id") id: String?
    ): Response<JsonObject>
    ...
    @POST(ApiEndPoint.createOrderInstaCart)
    suspend fun getInstaCart(
        @Body jsonObject: JsonObject?
    ): Response<JsonObject>
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.getRecipeByUrl)
    ...
    @FormUrlEncoded
    @POST(ApiEndPoint.scheduleUrl)
    suspend fun getScheduleTimeApi(
        @Field("date") date: String?,
        @Field("day") days: String?,
        @Field("is_current") isCurrent: String?
    ): Response<JsonObject>


    @FormUrlEncoded
    @POST(ApiEndPoint.setScheduleUrl)
    suspend fun setScheduleTimeApi(
        @Field("date") date: String?,
    ...
    suspend fun getOrderProductUrl(@Body jsonObject: JsonObject): Response<JsonObject>
    ...
    suspend fun getSelectProductsUrl(@Field("id") id:String?,@Field("product_id") productId:String?,@Field("sch_id") schId:String?): Response<JsonObject>

    @FormUrlEncoded
    @POST(ApiEndPoint.getAllIngredientsUrl)
    suspend fun getAllIngredientsUrl(@Field("category") category:String?,
                                     @Field("search") search:String?,
                                     @Field("number") number:String?): Response<JsonObject>
    ...
    suspend fun basketYourRecipeIncDescUrl(@Field("uri") uri:String?,@Field("quantity") quantity:String?,@Field("type") type: String): Response<JsonObject>
  ...
  @FormUrlEncoded
    ...
    suspend fun updateDietSuggestionUrl(
        ...
        @Field("macros") macros: String?,
        @Field("calories") calories: String?,
        @Field("fat_per") fatPer: String?,
        @Field("protein_per") protein: String?,
        @Field("carbs_per") carbs: String?,
        @Field("typeStatus") typeStatus: String?
    ): Response<JsonObject>
    ...
    suspend fun orderWeekUrl(@Field("start_date") startDate:String?,
