...
import com.mykaimeal.planner.fragment.mainfragment.commonscreen.checkoutscreen.model.Note
    ...
    override fun onClick(item: View?) {
        when (item!!.id) {
            ...
            R.id.relMeetDoor -> {
                ...
                binding.imgMeetOutside.setImageResource(R.drawable.radio_uncheckssss)
                ...
                binding.imgMeetReception.setImageResource(R.drawable.radio_uncheckssss)
                ...
                binding.imgLeaveAtDoor.setImageResource(R.drawable.radio_uncheckssss)
                ...
                binding.imgLeaveReception.setImageResource(R.drawable.radio_uncheckssss)
            }
            ...
            R.id.relMeetOutSide -> {
                ...
                binding.imgMeetDoor.setImageResource(R.drawable.radio_uncheckssss)
        ...
        try {
            ...
            if (apiModel.code == 200 && apiModel.success == true) {
                if (dropOffOptionsScreenViewModel.dataCheckOut?.note!= null) {
                    ...
                    val note = Note(instructions, 0, clickedstatus, 1)
                    dropOffOptionsScreenViewModel.dataCheckOut?.note = note
                }
