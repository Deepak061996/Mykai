package com.mykaimeal.planner.fragment.mainfragment.cookedtab.apiresponse

import com.google.gson.annotations.SerializedName

data class CookedTabRandomModel(
    val code: Int,
    val `data`: CookedTabRandomModelData?,
    val date: String?,
    val message: String,
    val success: Boolean
)
...
data class CookedTabRandomModelData(
    val fridgeData :CookedTabFridgeDataModel?,
    val freezerData :CookedTabFridgeDataModel?,
    val fridge:Int?,
    val freezer:Int?,
    val date:String?
)
...
data class CookedTabFridgeDataModel(
    ...
    val Dessert: MutableList<Breakfast>?
)
