...
class FilterSearchViewModel @Inject constructor(private val repository: MainRepository) : ViewModel()  {
    ...
    private var _fullListCuisines: MutableList<DishType>? = null
    private var _fullListProtein: MutableList<Protein>? = null
    ...
    val fullListCuisines: MutableList<DishType>? get() = _fullListCuisines

    val fullListProtein: MutableList<Protein>? get() = _fullListProtein
    ...
    fun setFullListCuisines(data: MutableList<DishType>?){
        _fullListCuisines=data
    }
  fun setFullListProtein(data: MutableList<Protein>?){
      _fullListProtein=data
    }
